    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            $adminData = App\Models\User::find($id);
                    @endphp
                    <img src="{{!empty($adminData->photo) ? url('uploads/admin/images/'.$adminData->photo) : url('uploads/images/no_image.jpg')}}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{route('admin.profile')}}"><i class="bx bx-user"></i><span>Thông tin tài khoản</span></a>
                    </li>
