...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Thông tin tài khoản người bán</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Thông tin tài khoản người bán</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img
                                        src="{{!empty($vendorData->photo) ? url('uploads/vendor/images/'.$vendorData->photo) : url('uploads/images/no_image.jpg')}}"
                                        alt="{{Auth::user()->name}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select name="vendor_join" class="form-select mb-3">
                                                <option selected>Chọn ngày tham gia</option>
